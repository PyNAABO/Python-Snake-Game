...
def main():
	...
	while exit_game:
		if game_over:
			...
			textsurface = myfont.render("Game Over ! Press Space to Continue", True,
			                            black)
